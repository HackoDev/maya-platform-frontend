...
## Project Structure
The Support Module is organized following a feature-based architecture within the larger Maya Platform frontend application. Components, services, and composables are grouped under dedicated directories to promote separation of concerns and ease of maintenance. The recent update has added a new SupportTicketDialogPage.vue and associated components for detailed ticket interaction, while refactoring the SupportHistorySection to remove status counters and add refresh functionality.
