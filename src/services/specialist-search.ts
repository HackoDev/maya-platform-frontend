...
export class SpecialistSearchService {
  private fakeSpecialists: SpecialistProfile[] = [
    ...
    // Additional specialists for pagination testing
    {
      ...
      superpower: 'Разрабатываю AI-решения для e-commerce и настраиваю умные рекомендательные системы',
      avatarUrl: undefined,
      specializations: ['Автоматизация', 'Нейроассистенты (AI-боты)'],
      abilities: ['Создаю рекомендательные системы', 'Интегрирую AI в e-commerce'],
      services: [
        {
