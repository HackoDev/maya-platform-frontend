      ...
      <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div class="flex flex-col space-y-3 sm:hidden">
          <button
            type="submit"
            :disabled="loading"
            class="w-full inline-flex items-center justify-center px-3 py-1.5 border border-transparent text-sm font-medium 
          ...
          <button
            ...
            class="w-full inline-flex items-center justify-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 
      ...
      <div class="flex flex-wrap gap-2">
        ...
        >
          ...
          <button
            ...
            class="ml-2 text-green-600 dark:text-green-300 hover:text-green-800 dark:hover:text-green-100 
                   flex-shrink-0"
          >
            ×
          </button>
