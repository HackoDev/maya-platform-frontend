    ...
    <div class="form-footer">
      <div class="footer-content">
        ...
        <div class="footer-actions">
          <div v-if="profile?.status === 'published'" class="text-sm text-green-700 dark:text-green-300">
            Ваша анкета опубликована, вы также можете вносить изменения.
          </div>
          <div v-else-if="profile?.readyForReview" class="text-sm text-blue-700 dark:text-blue-300">
